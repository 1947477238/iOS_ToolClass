...
#define LandscapeLeft [[UIApplication sharedApplication] statusBarOrientation] == UIInterfaceOrientationLandscapeRight

#define LandscapeRight [[UIApplication sharedApplication] statusBarOrientation] == UIInterfaceOrientationLandscapeLeft
...
//兼容横竖屏判断获取宽高
#define SCREEN_WIDTH        (!isPortrait  && FFDeviceHeight>FFDeviceWidth?FFDeviceHeight:FFDeviceWidth)

#define SCREEN_HEIGHT        (!isPortrait  && FFDeviceHeight>FFDeviceWidth?FFDeviceWidth:FFDeviceHeight)

//获取statusbar高度
#define FFStatusBarHeight  (isIPhoneXSeries()? 44.f : 20.f)

// Tabbar safe bottom margin.
#define  TabbarSafeBottomMargin         (isIPhoneXSeries()? 34.f : 0.f)
